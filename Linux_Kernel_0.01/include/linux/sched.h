...
/* This is possibly a PCB of a process!!!!!!!!!!!!!   */
...
/* these are hardcoded - don't touch */
	...
	fn_ptr sig_restorer;
	fn_ptr sig_fn[32]; /* 信号响应的数据结构, 对应信号要执行的操作和标志信息 */
/* various fields */
	int exit_code;  /* 任务执行停止的退出码,其父进程会取 */
	unsigned long end_code,end_data,brk,start_stack; /* start_code代码段地址,end_code代码长度(byte), end_data代码长度+数据长度(byte),brk总长度(byte),start_stack堆栈段地址 */
	...
	/* 用户态运行时间 (jiffs数),系统态运行时间 (jiffs数),子进程用户态运行时间,子进程系统态运行时间,进程开始运行时刻 */
